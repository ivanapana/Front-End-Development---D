...
//   age + 1
// } tahun dan saya tinggal di ${alamat}`;
...
let Taiwan = countries.findIndex((country) => country === "Taiwan");
console.log(Taiwan);
// Dengan menggunakkan arrow gunction cari index negara Taiwan
// clue: findIndex()
